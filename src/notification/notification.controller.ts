...
export class NotificationController {
  ...
  @UseGuards(AuthGuard)
  @Post("subscribe")
  registerNotificationToken(@Body() acceptNotificationDTO: AcceptNotificationDTO, @RequestUser() user: TokenInfo){
    return this.notificationService.acceptPushNotification(user, acceptNotificationDTO);
  }
  ...
  @UseGuards(AuthGuard)
  @Post("unsubscribe")
  disableNotificationToken(@Body() updateDTO: UpdateNotificationDTO, @RequestUser() user: TokenInfo){
